...
/**
 * En esta clase lo que se hace es hacer una prueba de la cancion que vas a meter y va a sonar
 * 
 * @author samuel
 * 
 * @version 1.420
...
public class PruebaCancion {
	public static void main(String[] args) {
		...
		Cancion cuartaCancion = new Cancion("Goteo", "Duki", 420, false);
		Cancion quintaCancion = new Cancion("She dont give a fo", "Duki", 420, false);
